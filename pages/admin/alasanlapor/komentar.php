                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if (isset($_GET['cari'])) {
                                        $cari = $_GET['cari'];
                                        $data = mysqli_query($koneksi, "SELECT * from tb_alasanlapor where targetalasan ='komentar' AND judul_alasan like '%" . $cari . "%' OR deskripsi like '%" . $cari . "%' ORDER BY id_alasanlapor DESC ");
