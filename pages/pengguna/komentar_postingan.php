<div class="card-header">
    ...
    <div class="user-block">
        ...
        <span class="username"><a href="profil/profil.php?id=<?= $d['id_pengguna']; ?>"><?php echo $d['nm_pengguna']; ?>
                </li></a>
        </span>
        <span class="description"><?php echo $d['nm_topik']; ?> -
            <?php echo $d['kredensial']; ?></span>
    </div>
    <?php
    } else {
    ?>
    <div class="user-block">
        <img class="img-circle" src="../../dist/img/anonim.png" style="object-fit: cover;" alt="User Image" />
        <span class="username">
            Anonim
        </span>
        <span class="description"><?php echo $d['nm_topik']; ?> - Informasi
            dirahasiakan</span>
    </div>
    <?php
    }
...
<div class="card-body">
    ...
    ?>
    <div class="col-sm">
        <a href="dist/img/postingan/<?php echo $dgambar['nm_gambar'] ?>" data-toggle="lightbox" data-gallery="gallery">
    ...
    <div class="modal-dialog modal-lg">
        <form action="laporkan.php" method="POST">
            <div class="modal-content " style="width: 90%;">
                ...
                <input type="hidden" id="id_komentar" name="id_komentar" value="<?php echo $d['id_komentar']; ?>">
                <input type="hidden" id="id_postingan" name="id_postingan" value="<?php echo $d['id_postingan']; ?>">
