...
if (isset($_GET['id'])) {
    ...
    $perbandingan = ($id_penggunalain == $_SESSION["id_pengguna"]);
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-tabs row" id="custom-tabs-four-tab" role="tablist"
                                            ...
                                            <li class="nav-item col text-center active">
                                                <a class="nav-link " href="profil.php?id=<?= $id_penggunalain ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="12">
                                        ...
                                        $data = mysqli_query($koneksi, "SELECT * from tb_postingan inner join tb_pengguna on tb_postingan.id_pengguna = tb_pengguna.id_pengguna INNER JOIN tb_topik ON tb_postingan.id_topik = tb_topik.id_topik where tb_postingan.id_pengguna = '$id_pengguna'  and tb_postingan.tipe = 'BERBAGI' ORDER BY id_postingan DESC");
