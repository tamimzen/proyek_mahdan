            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $data = mysqli_query($koneksi, "SELECT * from tb_lapor inner join tb_alasanlapor on tb_lapor.id_alasanlapor = tb_alasanlapor.id_alasanlapor INNER JOIN tb_pengguna ON tb_lapor.id_pengguna = tb_pengguna.id_pengguna where target ='pengguna' AND tgl like '%" . $cari . "%' OR deskripsi_tambahan like '%" . $cari . "%' OR judul_alasan like '%" . $cari . "%' ORDER BY id_lapor DESC ");
