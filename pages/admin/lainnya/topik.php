    ...
    <ul class="navbar-nav">
        ...
        <li>
            ...
            <div class="form-inline">
                <form action="topik.php" method="get">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="topik.php" class="nav-link active">
                        <i class="fas fa-circle nav-icon"></i>
                        <p>Daftar Topik</p>
                    </a>
                </li>
                    ...
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $data_hal = mysqli_query($koneksi, "SELECT * FROM tb_topik");
                                $jumlah_data = mysqli_num_rows($data_hal);
                                $total_halaman = ceil($jumlah_data / $batas);

                                if (isset($_GET['cari'])) {
                                    $cari = $_GET['cari'];
                                    $data = mysqli_query($koneksi, "SELECT * from tb_topik where nm_topik like '%" . $cari . "%' ORDER BY id_topik DESC ");
                                    while ($d = mysqli_fetch_array($data)) {
                                ?>

                                <?php include 'listtopik.php' ?>
                            </tbody>
                            ...
                            <?php
                                    ...
                                    $data = mysqli_query($koneksi, "SELECT * from tb_topik ORDER BY id_topik DESC limit $halaman_awal, $batas   ");
