                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="12">
                                        ...
                                        $data = mysqli_query($koneksi, "SELECT * from tb_postingan inner join tb_pengguna on tb_postingan.id_pengguna = tb_pengguna.id_pengguna INNER JOIN tb_topik ON tb_postingan.id_topik = tb_topik.id_topik where tb_postingan.id_pengguna = '$id_pengguna' and tb_postingan.tipe = 'TANYA' ORDER BY id_postingan DESC");
