    ...
    <ul class="navbar-nav">
        ...
        <li>
            ...
            <div class="form-inline">
                <form action="kata.php" method="get">
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="kata.php" class="brand-link">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  if (isset($_GET['cari'])) {
                    $cari = $_GET['cari'];
                    $data = mysqli_query($koneksi, "SELECT * from tb_kata where nm_kata like '%" . $cari . "%' ORDER BY id_kata ASC ");
