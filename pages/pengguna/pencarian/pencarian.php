                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="12">
                            ...
                            if (isset($_GET['cari_pencarian']) || isset($_GET['cari_tipe'])){ 
                                $cari_pencarian = $_GET['cari_pencarian'];
                                $cari_tipe = $_GET['cari_tipe']; 
                            ...
                            // <!-- munculin pencarian profil  -->
                            include 'postinganprofil.php';
                            // <!-- munculin pencarian postingan --> 
                            include 'postingan.php';
                             } else {echo "tidak ada pncarian";}?>
