        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  if (isset($_GET['cari'])) {
                    $cari = $_GET['cari'];
                    $data = mysqli_query($koneksi, "SELECT * from tb_alasanlapor where targetalasan ='pengguna' AND judul_alasan like '%" . $cari . "%' OR deskripsi like '%" . $cari . "%' ORDER BY id_alasanlapor DESC ");
